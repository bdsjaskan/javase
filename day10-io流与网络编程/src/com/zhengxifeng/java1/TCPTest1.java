 ...
 *
 * 实现TCP的网络编程
 * 例子1：客户端发送文件给服务端，服务端输出到控制台
 *
 * @author shkstart
 * @create 2022-02-08 19:19
 */
public class TCPTest1 {
    ...
    public void server(){
        ...
        Socket socket = null;
        InputStream is = null;
        ByteArrayOutputStream baos = null;   //将数据输出存储到 baos 会自动扩容的内部数组中
        try {
...
//            }
            ...
            int len;
            while ((len = is.read(buffer)) != -1){//已经把数据读入到buffer[] 数组中
