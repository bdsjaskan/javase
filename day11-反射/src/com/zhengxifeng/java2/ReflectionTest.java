...
public class ReflectionTest {
    ...
    /*
    如何操作运行时类中的指定的方法 -- 需要掌握的
     */

    @Test
    public void testMethod() throws Exception {
        Class clazz = Person.class;
        //创建运行时类的对象(针对非静态的方法使用)
        Person p = (Person) clazz.newInstance();
