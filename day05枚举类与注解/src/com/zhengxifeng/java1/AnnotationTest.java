 ...
 * ① jdk 5.0 新增的功能
 *
 * ② Annotation其实就是代码里的特殊标记，这紫标记可以在编译,类加
...
//@MyAnnotations({@MyAnnotation(value = "hi"),@MyAnnotation(value = "nihao")})
